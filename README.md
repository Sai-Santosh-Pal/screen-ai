...
## Instructions 
1. Go to Releases and download the source code zip and unzip it
2. Open your terminal - PLEASE MAKE SURE YOU RUN ONLY VIA THE TERMINAL 
3. `cd` to the extracted directory
4. Type `./dist/main and press enter
5. Keep it up and running while you open the dashboard on the given link
